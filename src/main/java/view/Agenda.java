...
import controller.RegisterAgendamentoController;
...
public class Agenda extends javax.swing.JFrame {
    ...
    private final RegisterAgendamentoController controller;
    private EntityManager em; 

    public Agenda() {
        initComponents();
        setLocationRelativeTo(null);  // Define a localização da janela
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);  // Fecha a janela ao ser fechada
        controller = new RegisterAgendamentoController(this);
        iniciar();
    }
    ...
    private void initComponents() {
        ...
        LabelAgendaPainelFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Agenda-PainelFundo.png"))); // NOI18N
        getContentPane().add(LabelAgendaPainelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 1000));

        LabelAgendaFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/AgendaFundo.png"))); // NOI18N
